...
const dashboard = new ParseDashboard({
  apps: [
    {
      serverURL: "https://parse-server-example-" + process.env.PROJECT_NAME + ".7e14.starter-us-west-2.openshiftapps.com/parse", //"https://parse-server-example-" + process.env.PROJECT_NAME + ".1d35.starter-us-east-1.openshiftapps.com/parse",//process.env.SERVER_URL || "http://localhost:1337/parse",
      appId: process.env.APP_ID || "myAppId",
